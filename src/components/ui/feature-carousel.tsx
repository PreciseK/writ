...
export function FeatureCarousel({ features = [], accentColor = "#62B2FE" }: FeatureCarouselProps) {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto md:p-8">
      <div
        className="relative overflow-hidden rounded-[2.5rem] lg:rounded-[4rem] flex flex-col lg:flex-row min-h-[600px] lg:aspect-video border border-white/10"
      >
        {/* Left panel */}
        <div
            ...
            {features.map((feature, index) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <div
                      className={cn("flex items-center justify-center transition-colors duration-500")}
